...
class InstagramState extends StatefulWidget {
  const InstagramState({Key? key}) : super(key: key);

  @override
  State<InstagramState> createState() => StatefulInstagram();
}

class StatefulInstagram extends State<InstagramState> {
